    ...
    <section className={styles.aboutSection}>
      <div className={styles.content}>
        <div className={styles.text}>
          <h2 className={styles.title}>$ALFY</h2>
          <h2>
          ...
          <p>
            ...
            <strong> Alephium</strong>, that’s <strong>$ALFY</strong>. We know Alephium has 
            <strong> massive potential</strong>, it’s going to take off, and <strong>$ALFY</strong> 
          ...
          {isExpanded && (
            <p>
              But <strong>$ALFY</strong> is, above all, about the <strong>community</strong>. 
              ...
              is part of the story we’re creating. With <strong>$ALFY</strong>, we’re showing 
